...
imNames = ppImageMaster(:, 2);
imNames = strrep(imNames,'.mat','.jpg');
imNames = strrep(imNames,'structs_','ish_');
imNames = strrep(imNames,'ish_new','ish_color');
...
%% Save result
save(fullfile(get_root(), 'feature_extraction', 'data', 'featCNN_pp_color.mat'), 'fc7Features');
