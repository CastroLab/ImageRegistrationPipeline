...
PathToPaths = 'D:\METHODS_PAPER\clustering\data\CNNfeat_GMM\7_clusters_FullSigma_UnSharedCovariance\100_closest_im_paths.mat';
load(PathToPaths)

selCluster = 7;

im_paths = im_paths{selCluster};
nfiles = numel(im_paths);
...
mirt_images = mirt_images(:,:,[1:3,11,13:14,16:20]);
